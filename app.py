...
df= pd.read_csv('C:/Users/lenovo/Downloads/athlete_events.csv')
df_region= pd.read_csv('C:/Users/lenovo/Downloads/noc_regions.csv')
...
if user_menu == 'Country-wise Analysis':  
    ...
    st.title(selected_country+'\'s Medal Tally over the year')
